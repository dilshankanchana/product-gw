...
/**
 * AssertValidationTestCase
 */
public class AssertValidationTestCase {
    ...
    @Test public void testWithBodyWithHeaderPOSTMethod() {
        Boolean response = Emulator.getHttpEmulator().client()
                ...
                .when(HttpClientRequestBuilderContext.request().withPath("/users/user10").withMethod(HttpMethod.POST)
                        .withBody("user10").withHeader("Header1", "value1"))
                .then(HttpClientResponseBuilderContext.response().withBody("user10")
                        .withHeader("Header1", "value1")).operation().send();

        Logger.getLogger(DefaultResponseTestCase.class).info(response);
    }
    ...
    /*@Test public void testWithoutBodyWithPOSTMethod() {
        Boolean response = Emulator.getHttpEmulator().client()
                ...
                .then(HttpClientResponseBuilderContext.response()).operation().send();

        System.out.println("response: " + response);
    }

    @Test public void testBodyWithGETMethod() {
        Object response = Emulator.getHttpEmulator().client()
                .given(HttpClientConfigBuilderContext.configure().host("127.0.0.1").port(6065))
                .when(HttpClientRequestBuilderContext.request().withPath("/users/user1").withMethod(HttpMethod.GET))
                .then(HttpClientResponseBuilderContext.response().withBody("user1").withHeader("Header1", "value1")).operation().send();
    ...
    @Test public void test2() {
        Emulator.getHttpEmulator().client()
                .given(HttpClientConfigBuilderContext.configure().host("127.0.0.1").port(6065))
                .when(HttpClientRequestBuilderContext.request().withPath("/user/wso2").withMethod(HttpMethod.POST)
                        .withBody("TestRequest1").withHeader("Header1", "value1")
                        .withQueryParameter("Query1", "value1"))
                .then(HttpClientResponseBuilderContext.response().withBody("TestResponse1")
                        .withHeader("Header1", "value1")).operation().send();
    }
    ...
    @Test public void testBodyWithPOSTMethod() {
        Boolean response = Emulator.getHttpEmulator().client()
                ...
                .when(HttpClientRequestBuilderContext.request().withPath("/users/user2").withMethod(HttpMethod.POST)
                        .withBody("user2")).then(HttpClientResponseBuilderContext.response()).operation().send();
    ...
    @Test public void testBodyWithHeadersBodyPOSTMethod() {
        Object response = Emulator.getHttpEmulator().client()
                .given(HttpClientConfigBuilderContext.configure().host("127.0.0.1").port(6065))
    ...
    @Test public void testBodyWithRequestBodyHeadersBackInResponse() {
        HttpClientResponseProcessorContext response = Emulator.getHttpEmulator().client()
                .given(HttpClientConfigBuilderContext.configure().host("127.0.0.1").port(6065))
    ...
    @Test public void testBodyWithRequestBodyHeadersQueryParametersBackInResponse() {
        HttpClientResponseProcessorContext response = Emulator.getHttpEmulator().client()
                .given(HttpClientConfigBuilderContext.configure().host("127.0.0.1").port(6065))
    ...
    private HttpServerOperationBuilderContext startHttpEmulator() {
        return Emulator.getHttpEmulator().server().given(configure().host("127.0.0.1").port(6065).context("/users"))
                ...
                //test1
                .when(request().withMethod(HttpMethod.POST).withPath("/user10").withBody("user10")
                        .withHeader("Header1", "value1"))
                .then(response().withBody("user10").withHeader("Header1", "value1")
                ...
                .then(response().withBody("@{body} @{header.Header9} @{query.Query9}")
                        .withStatusCode(HttpResponseStatus.OK).withHeader("Header-res9", "value9")).operation().start();
    }
}
